...
本文简要介绍SSL/TLS协议的运行机制。文章的重点是设计思想和运行过程，不涉及具体的实习细节。如果想了解这方面的内容，请参阅[RFC文档](http://tools.ietf.org/html/rfc5246)。

![bghttps](mdPhotoSource/bghttps.jpg)
...
![bghandshake](mdPhotoSource/bghandshake.png)
...
![bgHandshakeProtocol](mdPhotoSource/bgHandshakeProtocol.gif)
