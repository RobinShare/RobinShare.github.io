...
请特别注意，如果不保存，会影响到后面的方法执行，这个地方很多人出错，在蓝牙交流群中每天几乎都会因为这个问题导致无法连接和影响对外设后续的操作。
...
[GitHub上的下载地址：](https://github.com/coolnameismy/demo)

本文代码存放目录是BleDemo   



[From where](http://liuyanwei.jumppo.com/2015/08/14/ios-BLE-2.html)
